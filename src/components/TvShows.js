        ...
        return (
          <fragment key={show.id}>   
            <div id={trailer ? "container" : "NoContainer"}>
              <AiFillPlayCircle color="green" fontSize={40} id={trailer ? "playIcon" : "hide"} onClick={() => TvShowTitle(show)}/>
              <img src={show.poster_path ? `${images}${show.poster_path}` : NoImage} alt="NoImage" onClick={() => TvShowTitle(show)}/>
